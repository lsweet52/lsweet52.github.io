...
create table nation(
    ...
    constraint fk_region_key foreign key (region_key) references region(region_key),
...
create table partsupp(
    ...
    constraint fk_supp_key foreign key (supp_key) references supplier(supp_key),
...
create table orders(
    ...
    constraint fk_cust_key foreign key (cust_key) references customer(cust_key),
...
create table lineitem(
    ...
    constraint fk_order_key foreign key (order_key) references orders(order_key),
    part_key int comment '零件编号',
    constraint fk_part_key foreign key (part_key) references part(part_key),
    supp_key int comment '供应商编号',
    constraint fk_supp_key foreign key (supp_key) references supplier(supp_key),
    ...
    constraint fk_part_supp_key foreign key (part_key, supp_key) references partsupp(part_key, supp_key)
)comment '订单明细表';
